      ...
      <div class="col-sm-8 col-sm-offset-6">
          <div class="form-group">
               <label>First Name <small>*</small></label>
                    <input name="firstName" type="text" class="form-control" placeholder="Input First Name">
          </div>
          <div class="form-group">
               <label>Last Name <small>*</small></label>
                    <input name="lastName" type="text" class="form-control" placeholder="Input Last Name">
          </div>
      </div>
